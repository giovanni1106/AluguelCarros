...
public class SeguroExcluir extends JFrame {

	private JPanel contentPane;
	private static SeguroExcluir frame;
	 ...
	 * Create the frame.
	 */
	public SeguroExcluir(SeguroCarro se) {
		setTitle("Excluir seguro");
		...
		JLabel lblCarro = new JLabel(se.getIdentificacao());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(SeguroCarro.Excluir(se) == true)
