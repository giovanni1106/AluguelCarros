...
public class MenuSeguros extends JFrame {
	...
	private static MenuSeguros frame;
	...
	public MenuSeguros() {
		...
		for(int i = 0; i < BancoDados.MAX; i ++)
			if(BancoDados.cadastrarCarro[i] != null)
				comboBox.addItem(BancoDados.cadastrarSeguro[i].getIdentificacao());
		...
		btnDetalhar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MostrarSeguro.Construtor(BancoDados.cadastrarSeguro[comboBox.getSelectedIndex()]);
			}
		});
	}
